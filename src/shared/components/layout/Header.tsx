...
export function Header({ variant = "full" }: HeaderProps) {
  ...
  return (
    <header
        className={cn(
          "z-50 h-14 transition-colors duration-300 md:h-20 sm:pt-0 md:pt-0",
          isMinimal ? "fixed inset-x-0 top-[var(--tg-safe-area-top,0px)] sm:pt-0 md:pt-0" : "sticky hidden md:block md:mx-auto md:w-[800px]",
