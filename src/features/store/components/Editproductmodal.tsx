 ...
 *
 * Changes:
 *  1. production_ready switch added next to is_limited_edition
 *  2. Markup number input alongside slider for direct entry
 *  3. Markup % applied to base_price (edit modal has no print cost context, same as before but explicit)
 *  4. Uses ConfirmModal for any confirmations — no browser confirm()
 */
